...
import { TopProfitable7DayCard } from '@/components/home/TopProfitable7DayCard';
...
export default async function Home() {
  ...
  const {
    ...
    shortSignals,
    profitableSignals,
    sevenDayProfitableSignals,
  } = await getHomeData(access);
  ...
  <div className="mb-8 pb-4 ">
    <p className="text-xs text-center font-semibold uppercase tracking-[0.18em] text-emerald-400">
      Results are probabilistic. Profits are never guaranteed.
    </p>
    <h2 className="mt-2 text-center text-2xl font-semibold tracking-tight text-white">
      Quantitative analysis and real-time data processing to surface<br /> stronger market opportunities.
    </h2>
  </div>
  ...
  <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
    {profitableSignals.map((signal) => (
      ...
      <section id="methodology" className="mx-auto max-w-6xl px-5 py-14 lg:px-8"><div className="grid gap-5 lg:grid-cols-[1.1fr_.9fr]"><TopProfitable7DayCard signals={sevenDayProfitableSignals} delayed={!access.premium} /><MethodologyCard /></div></section>
