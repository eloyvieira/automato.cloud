...
/**
 * Interactive part of the shared header: logo, nav links and auth actions.
 * Authentication state is resolved on the server and passed in, so the menu
 * never guesses whether someone is logged in.
 */
